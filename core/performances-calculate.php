<?php 
    ...
    $query = "SELECT COUNT(`performance id`) FROM performances WHERE `Approved` = '1' and `Start date` > '$today' AND ((`Hall existence` = '0' AND `Places number` > '0') OR `Hall existence` = '1')";
